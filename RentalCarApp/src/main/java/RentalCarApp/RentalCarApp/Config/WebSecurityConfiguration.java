package RentalCarApp.RentalCarApp.Config;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests(reqest->
                reqest.requestMatchers("/api/auth/**").permitAll()
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userService.userDetailsSerices());
